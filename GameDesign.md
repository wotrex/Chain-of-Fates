...
За повне виконання деяких задач(в основном професійних) росте [достаток жителя](#wealth-points).

| Задача     | Відмінювана | Порядок дій    | Умови | Стан       | Професія | +Достаток |
|------------|-------------|----------------|-------|------------|----------|-----------|
...
1. Відпочинок - стандартний стан. В цьому стані житель не виконує роботу і трохи відновлює витривалість. Задачі цього стану виконуються випадково(або по порядку можна зробити).
