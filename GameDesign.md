...
Об'єкти на мапі діляться ті з якими можна взаємодіяти і ті з якими не можна взаємодіяти. Ті з якими можна взаємодіяти мають свій запас ресурсів і можуть бути відновлюваними і невідновлюваними. Кожен об'єкт, з яким можна взаємодіяти, дає певний ресурс. Якщо запас ресурса мінімальний і об'єктом уже хтось зайнятий, то він перестає бути видимим для інших [жителів](#dweller). Якщо запас ресурсів об'єкта = 0, то цей об'єкт перестає бути видимим для [жителів](#dweller), а якщо він ще і не відновлювальний, то через `ПЕВНИЙ ЧАС ДЛЯ ВИДАЛЕННЯ` він пропадає.

| Об'єкт         | Можна взаємодіяти? | Ресурс       | Запас ресурса         | Відновлювальний | Час на відновлення(ресурс/день) |
|----------------|--------------------|--------------|-----------------------|-----------------|---------------------------------|
| <span id="tree" style="color:green">Дерево</span>         | Так                | Деревина     | `ЗАПАС ДЕРЕВА`        | НІ              |                                 |
| <span id="grass" style="color:lime">Трава</span>         | Ні                 |              |                       |                 |                                 |
| <span id="berries" style="color:Fuchsia">Ягоди</span>          | Так                | Ягоди        | `ЗАПАС ЯГІД`          | ТАК             | `ВІДНОВЛЕННЯ ЯГІД`              |
| <span id="river" style="color:aqua">Річка</span>          | Так                | Риба         | `ЗАПАС РИБИ РІЧКА`    | ТАК             | `ВІДНОВЛЕННЯ РИБИ`              |
| <span id="lake" style="color:aqua">Озеро</span>          | Так                | Риба         | `ЗАПАС РИБИ ОЗЕРО`    | ТАК             | `ВІДНОВЛЕННЯ РИБИ`              |
| <span id="stones" style="color:grey">Каміння</span>        | Так                | Камінь       | `ЗАПАС КАМІННЯ`       | НІ              |                                 |
| <span id="iron-deposits" style="color:Brown">Поклади заліза</span> | Так                | Залізна руда | `ЗАПАС ЗАЛІЗНОЇ РУДИ` | НІ              |                                 |
...
Житель завжди має якусь задачу. Кожна задача описує порядок дій та їхні цілі. Кожна задача належить якомусь стану. 